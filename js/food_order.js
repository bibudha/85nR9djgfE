            ...
            if (validateTime == 1) {
                ...
                $.each(html, function (i, item) {
                    if (counter > i) {
                        ...
                        data += '<li  class="' + className + '" ><a rel="external"  href="food_category.html?location=' + item.locationId + '&transferId=' + featureRelId + '&touchId=' + userSiteId + '" data-transition="flip" >' + item.city + '</a></li>';
                    }
                });
                data += '</ul>';
            ...
            if (validateTime == 1) {
                ...
                $.each(html, function (i, item) {
                    if (counter > i) {
                        ...
                        data += '<li  class="' + className + '"><a rel="external" href="food_item.html?location=' + location + '&cId=' + item.categoryId + '&transferId=' + featureRelId + '&touchId=' + userSiteId + '" data-transition="slide">' + item.Name + ' (' + item.total_item + ')</a></li>';
                    }
                });
                data += '</ul>';
                $('#main-content').html(data);
                ...
                $.each(html, function (i, item) {
                    if (counter > i) {
					 var className = 'evenbg';
                        ...
                        data += '<li  class="' + className + '"><a rel="external" href="food_item_detail.html?location=' + location + '&iId=' + item.serviceId + '&transferId=' + featureRelId + '&cId=' + categoryId + '&touchId=' + userSiteId +
